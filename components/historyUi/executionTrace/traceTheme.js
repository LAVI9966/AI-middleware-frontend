...
export const HUE_THEME = {
  "trace-blue": {
    ...
    headOpen: `rounded-lg ${TRACE_ROW_BORDER} bg-trace-blue/[0.04]`,
  ...
  "trace-green": {
    ...
    headOpen: `rounded-lg ${TRACE_ROW_BORDER} bg-trace-green/[0.04]`,
  ...
  "trace-gold": {
    ...
    headOpen: `rounded-lg ${TRACE_ROW_BORDER} bg-trace-gold/[0.04]`,
